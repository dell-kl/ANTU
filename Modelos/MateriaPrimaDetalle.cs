...
namespace Modelos
{
    ...
    {
        private int nValoresListadoKgSeguimiento;
        ...
        public int NValoresListadoKgSeguimiento
        {
            set => SetProperty(ref nValoresListadoKgSeguimiento, value);
            get => nValoresListadoKgSeguimiento;
        }
